            ...
            <div class="border-bottom pb-3 mb-4">
              ...
              <div class="d-flex question-meta">
                <div class="me-3">
                  ...
                  <time :datetime="question.created_at.machine">{{question.created_at.human}}</time>
                </div>
                <div class="me-3">
                  <span class="text-muted">Modified</span> {{question.updated_at.human}}
                </div>
                <div><span class="text-muted">Viewed</span> {{question.views_count}}</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="question-content post-item">
              ...
              <div class="post-col actionable">
                ...
                >
                  ...
                  <Author :post-at="question.created_at" :user="question.user"></Author>
                </div>
                ...
                <div class="post-col actionable">
                  <div class="question-body">
                    <p>
                      ...
                      Voluptate, tenetur! Deleniti, dicta qui. Debitis quidem ad
                      laborum incidunt itaque nostrum, officiis eaque
                      perspiciatis ratione magni assumenda rerum fuga ut omnis.
                    </p>
                  </div>
              ...
              <div class="post-item my-4 border-bottom">
                ...
                <div class="post-col actionable">
                  <div class="question-body">
                    <p>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Fuga soluta error amet sed, earum sapiente, iure, facilis
                      tempore aspernatur quidem odit. Minima nulla numquam ad
                      voluptate! Laboriosam quisquam necessitatibus error.
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                      Quis ea, numquam excepturi repellat quas commodi, corporis
                      magnam eveniet hic quaerat alias dolor sint dolores neque
                      ratione porro maiores unde odio.
                    </p>
                  </div>
                  <div class="d-flex justify-content-end mb-2">
                    <div class="author">
